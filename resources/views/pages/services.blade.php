...
<div class="container">
    ...
    {{-- @for ($i = 0; $i<100; $i++) --}}
<style>
.service-price-txt, .service-name-txt {
    font-weight: 600;
}
                ...
                <div class="card">
                    ...
                    <h5 class=" mb-0">
                        <button class="btn btn-link" data-toggle="collapse"
                            ...
                            <button class="btn btn-link float-right"><h4 class="service-price-txt">£ {{$service->service_price}}</h4></button>
                            <button
...
src="https://www.google.com/maps/embed/v1/undefined?origin=...&q=...&destination=...&center=...&zoom=...&key=..." allowfullscreen></iframe>
        ...
        <div class="text-center font-italic"><p>Rating based on 45 user reviews</p></div>
        ...
        <div class="text-center font-italic"><p>Bank holiday opening hours may vary.</p></div>
        ...
        <a href="{{'tel:01604123456'}}"><button type="button" class="btn btn-lg btn-primary callbtn"
                style="margin-right:10px; margin-bottom:10px;"><h4 class="text-white">
                    <i class="fas fa-phone-alt text-white"></i> 01604 123456</h4></button></a>
